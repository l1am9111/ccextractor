...
struct s_teletext_config tlt_config = { NO, 0, 0, 0, NO, NO };
...
void telxcc_dump_prev_page (void)
{
	...
	{
		millis_to_date (prev_show_timestamp+subs_delay, c_temp1);
		millis_to_date (prev_hide_timestamp+subs_delay, c_temp2);
...
{	
	size_t short_len=strlen (c1)<strlen (c2)?strlen (c1):strlen (c2);	
