...
void usage (void)
{
	...
	mprint ("           -ru2 / ru3: roll-up captions can consist of 2, 3 or 4 visible\n");
	mprint ("                       lines at any time (the number of lines is part of\n");
	mprint ("                       the transmission). If having 3 or 4 lines annoys\n");
	mprint ("                       you you can use -ru2 to force the decoder to always\n");
	mprint ("                       use 2 lines, and -ru3 to always use 3 lines.\n");
	mprint ("\n");
